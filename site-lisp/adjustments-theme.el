...
(let ((hl1 "deep sky blue")
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t :background ,hl1)))

   `(ido-grid-match-1 ((t (:foreground ,hl1))))
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground ,hl1))))
   ...
   `(mode-line-highlight ((t (:foreground ,hl1))))
   `(mode-line-emphasis ((t (:foreground ,hl2))))

   `(isearch ((t (:background ,hl1))))
   `(isearch-fail ((t (:background ,hl2))))
